...
graduates.filter(function () {
  let checking = graduates.includes("Uni");
  if (graduates.university = checking) {
...
*/
const populationTotal = zooAnimals.reduce((base, current) => base + current.population, 0);
